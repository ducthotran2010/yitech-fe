  ...
  Heatmap = (function() {
    function Heatmap(targetId, screenshotUrl, positionData, opts) {
      ...
      background.onload = (function(_this) {
        return function() {
          var context, data, endPosition, i, maxViews, position, startPosition, value, views, viewsArray, _i, _j, _k, _l, _len, _len1, _m, _n, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _results, _results1, _results2;
          ...
          for (_k = 0, _len = _ref2.length; _k < _len; _k++) {
            ...
            for (_l = 0, _len1 = _ref3.length; _l < _len1; _l++) {
              ...
              endPosition = (position + data.height) >= 0 ? position + data.height : 0;
              ++_this.plus[startPosition];
              ++_this.minus[endPosition];
            }
          }
          views = 0;
          maxViews = 0;
