(function() {
  ...
  Heatmap = (function() {
    function Heatmap(targetId, screenshotUrl, positionData, opts) {
      ...
      this.screenshotOpacity =
        opts.screenshotAlpha === void 0 ? 0.6 : opts.screenshotAlpha;
      this.heatmapOpacity =
        opts.heatmapAlpha === void 0 ? 0.6 : opts.heatmapAlpha;
      this.calculateColor =
        opts.colorScheme === 'simple'
          ? this.simpleRedGradient
          : this.fiveColorGradient;
      ...
      background.onload = (function(_this) {
        return function() {
          ...
          _this.plus = function() {
            _results = [];
            for (
              var _i = 0, _ref = parseInt(_this.height);
          ...
          _this.minus = function() {
            _results1 = [];
            for (
              var _j = 0, _ref1 = parseInt(_this.height);
          ...
          viewsArray = [];
          for (
            i = _m = 0, _ref4 = parseInt(_this.height);
            0 <= _ref4 ? _m <= _ref4 : _m >= _ref4;
            i = 0 <= _ref4 ? ++_m : --_m
          ) {
            views += _this.plus[i];
            views -= _this.minus[i];
          ...
          _results2 = [];
          for (
            i = _n = 0, _ref5 = parseInt(_this.height);
